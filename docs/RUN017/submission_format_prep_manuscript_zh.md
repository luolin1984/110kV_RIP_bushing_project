...
RUN009A 基准工况为 STEADY_1250_LOAD_1p0，求解状态有效。Tmax_global 为 88.589 °C，导体、RIP、接触层、硅橡胶和法兰最高温度分别为 74.136、88.589、58.790、57.215 和 46.906 °C。各区域最高温度并不相同，说明 selection 保持了物理区分。基准电位、电场、介质损耗和温度指标见 Fig. 2。
...
RUN010 完成 125 组完整电场耦合稳态工况。Tmax_global 范围为 67.397 至 134.974 °C，Tmax_contact 最大为 129.925 °C。全局温度响应见 Fig. 3，接触区响应见 Fig. 4。油温升高会抬升整体温度，负荷升高使导体热和接触热按电流平方增大，接触电阻倍率升高主要增强接触层热点。代表工况热源分解见 Fig. 6。
...
RUN008 使用平均场参考介质损耗，RUN010 使用电场解积分介质损耗。替换后 Tmax_global 平均增加 0.617 °C，最大增加 2.816 °C，125 组中有 2 组风险分区变化，见 Fig. 7。该比较说明平均场参考适合早期诊断，但主矩阵应采用 field-coupled dielectric loss。
...
2. RUN009A 基准温度为 88.589 °C，RIP 电场耦合介质损耗为 28.049 W，field/ref 比值为 11.020。
3. RUN010 125 组工况中 Tmax_global_C 为 67.397-134.974 °C，Tmax_contact_C 最大为 129.925 °C。
...
5. RUN008 与 RUN010 对比得到 0.617 °C mean delta_Tmax、2.816 °C max delta_Tmax 和 2/125 changed risk zones。
